...
install -v -o 1000 -g 1000 -m 644 "rootfs/etc/mavlink-router.conf"  "${ROOTFS_DIR}/etc/mavlink-router/"
...
install -v -o 1000 -g 1000 -m 644 "rootfs/udev/rules.d/10-usb-serial.rules" "${ROOTFS_DIR}/udev/rules.d/"
